...
You can use this path and pass it as --train_path/--test_path accordingly to [generate_latents](../latent_pipeline/generate_latents.py). Each example in the dataset is then parsed into 5s chunks. 
